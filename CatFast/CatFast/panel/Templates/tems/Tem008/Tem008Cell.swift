...
class Tem008Cell: CollectionTemplate {
    var holder = Tem008CellHolder()
...
class Tem008CellModel: Cat {
    
    var name:String?
    var image:UIImage?
    
}
class Tem008CellHolder: Holder {
    var textOb = Observe()
    var imageOb = Observe()
    
    override func setModel(_ amodel: Cat) {
        super.setModel(amodel)
        if amodel is Tem008CellModel{
            let a = amodel as! Tem008CellModel
