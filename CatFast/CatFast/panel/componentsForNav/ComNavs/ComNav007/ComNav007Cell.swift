...
class ComNav007Cell: CollectionTemplate {
...
class ComNav007CellModel: Cat {
    
    var name:String?
    var image:UIImage?
    
}
class ComNav007CellHolder: Holder {
    var textOb = Observe()
    var imageOb = Observe()
    
    override func setModel(_ amodel: Cat) {
        super.setModel(amodel)
        if amodel is ComNav007CellModel{
            let a = amodel as! ComNav007CellModel
