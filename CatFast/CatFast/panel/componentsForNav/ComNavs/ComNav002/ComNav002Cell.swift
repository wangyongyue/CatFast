...
class ComNav002Cell: CollectionTemplate {
    var holder = ComNav002CellHolder()
...
class ComNav002CellModel: Cat {
    
    var name:String?
    var image:UIImage?
    
}
class ComNav002CellHolder: Holder {
    var textOb = Observe()
    var imageOb = Observe()
    
    override func setModel(_ amodel: Cat) {
        super.setModel(amodel)
        if amodel is ComNav002CellModel{
            let a = amodel as! ComNav002CellModel
