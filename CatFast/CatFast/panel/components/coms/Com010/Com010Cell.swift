...
class Com010Cell: CollectionTemplate {
    var holder = Com010CellHolder()
...
class Com010CellHolder: Holder {
    var textOb = Observe()
    var imageOb = Observe()
    
    override func setModel(_ amodel: Cat) {
        super.setModel(amodel)
        if amodel is Com010CellModel{
            let a = amodel as! Com010CellModel
