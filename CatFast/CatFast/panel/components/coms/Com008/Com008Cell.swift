...
class Com008Cell: CollectionTemplate {
    var holder = Com008CellHolder()
...
class Com008CellModel: Cat {
   
    var name:String?
    var image:UIImage?
    
}
class Com008CellHolder: Holder {
    var textOb = Observe()
    var imageOb = Observe()
    
    override func setModel(_ amodel: Cat) {
        super.setModel(amodel)
        if amodel is Com008CellModel{
            let a = amodel as! Com008CellModel
