...
class Com005Cell: CollectionTemplate {
    var holder = Com005CellHolder()
...
class Com005CellModel: Cat {
    
    var name:String?
    var image:UIImage?
    
}
class Com005CellHolder: Holder {
    var textOb = Observe()
    var imageOb = Observe()
    
    override func setModel(_ amodel: Cat) {
        super.setModel(amodel)
        if amodel is Com005CellModel{
            let a = amodel as! Com005CellModel
