...
class Com007Cell: CollectionTemplate {
    var holder = Com007CellHolder()
...
class Com007CellModel: Cat {
    
    var name:String?
    var image:UIImage?
    
}
class Com007CellHolder: Holder {
    var textOb = Observe()
    var imageOb = Observe()
    
    override func setModel(_ amodel: Cat) {
        super.setModel(amodel)
        if amodel is Com007CellModel{
            let a = amodel as! Com007CellModel
