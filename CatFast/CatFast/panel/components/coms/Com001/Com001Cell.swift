...
class Com001Cell: CollectionTemplate {
    var holder = Com001CellHolder()
...
class Com001CellModel: Cat {
    
    var name:String?
    var image:UIImage?
    
}
class Com001CellHolder: Holder {
    var textOb = Observe()
    var imageOb = Observe()
    
    override func setModel(_ amodel: Cat) {
        super.setModel(amodel)
        if amodel is Com001CellModel{
            let a = amodel as! Com001CellModel
