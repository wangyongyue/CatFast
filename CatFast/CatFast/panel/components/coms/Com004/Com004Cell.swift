...
class Com004Cell: CollectionTemplate {
    var holder = Com004CellHolder()
...
class Com004CellModel: Cat {
   
    var name:String?
    var image:UIImage?
    
}
class Com004CellHolder: Holder {
    var textOb = Observe()
    var imageOb = Observe()
    
    override func setModel(_ amodel: Cat) {
        super.setModel(amodel)
        if amodel is Com004CellModel{
            let a = amodel as! Com004CellModel
