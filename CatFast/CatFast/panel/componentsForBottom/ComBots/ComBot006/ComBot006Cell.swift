...
class ComBot006Cell: CollectionTemplate {
    var holder = ComBot006CellHolder()
...
class  ComBot006CellModel: Cat {
    
    var name:String?
    var image:UIImage?
    
}
class  ComBot006CellHolder: Holder {
    var textOb = Observe()
    var imageOb = Observe()
    
    override func setModel(_ amodel: Cat) {
        super.setModel(amodel)
        if amodel is ComBot006CellModel{
            let a = amodel as! ComBot006CellModel
